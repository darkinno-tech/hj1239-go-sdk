...
> *"We are darkinno-tech. Like a stout beer, our best ideas are brewed slowly in the dark, away from the hype."*
...
# Or via go:generate
//go:generate go run github.com/darkinno-tech/hj1239-go-sdk/cmd/gen ./model
```
...
```
ok  github.com/darkinno-tech/hj1239-go-sdk/codec      7 tests
ok  github.com/darkinno-tech/hj1239-go-sdk/crypto      5 tests
ok  github.com/darkinno-tech/hj1239-go-sdk/model      32 tests
ok  github.com/darkinno-tech/hj1239-go-sdk/packet      8 tests
ok  github.com/darkinno-tech/hj1239-go-sdk/transport    4 tests
```
